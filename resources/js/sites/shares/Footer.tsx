      ...
      <div className="container mx-auto px-6">
        <div className="grid lg:grid-cols-4 gap-12 mb-16">
          <div className="lg:col-span-1">
            <div className="flex items-center gap-2 mb-6">
              <div className="w-10 h-10 bg-brand rounded-xl flex items-center justify-center text-light font-bold shadow-lg shadow-brand/20">
                E
              </div>
              <span className="text-brand dark:text-highlight font-black text-2xl tracking-tighter uppercase">
                {APP_NAME}
              </span>
            </div>
          ...
          <div>
            <h4 className="font-bold text-brand dark:text-highlight mb-6 uppercase tracking-widest text-xs">Navigation</h4>
            <ul className="space-y-4">
              {NAV_LINKS.map(link => (
                <li key={link.name}>
                  <a href={link.href} className="text-slate-600 dark:text-slate-400 hover:text-brand dark:hover:text-highlight transition-colors font-semibold">
                    {link.name}
                  </a>
                </li>
              ))}
        ...
        <div className="pt-12 border-t border-brand/10 flex items-center justify-center">
          <p className="text-slate-500 dark:text-slate-500 text-sm font-bold">
            © {new Date().getFullYear()} {APP_NAME}. <span className="text-brand/50">L'éclat durable à Meknès.</span>
          </p>
        </div>
      </div>
    </footer>
